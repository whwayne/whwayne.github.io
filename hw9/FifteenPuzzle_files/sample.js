...

    {
      if (checkMove(parseInt(this.innerHTML))) {
        ...
        this.style.backgroundImage =
          "url('https://s-media-cache-ak0.pinimg.com/564x/83/72/12/837212dd8b71f9b5d175ac98f2c7668a.jpg')";
...
function checkMove(
  position // returns true whenever a piece can be moved into an empty space
) {
...
function left(
  x,
  y //calculates how far to the left a puzzlepiece should position
) {
...
function right(
  x,
  y //calculates how far to the right a puzzlepiece should position
) {
  var cordX = parseInt(x);
...
function up(
  x,
  y //calculates how far up a puzzlepiece should position
) {
  var cordX = parseInt(x);
  var cordY = parseInt(y);
...
function down(
  x,
  y //calculates how far down a puzzlepiece should position
) {
  var cordX = parseInt(x);
...
function swap(
  position //moves the puzzle piece by switching position with an empty space
) {
