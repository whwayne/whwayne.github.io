...
$(function(){
        ...
        var gamePiece = puzzleArea.getElementsByTagName("div");
        ...
        for (var i=0; i< gamePiece.length; i++) {
            ...
            gamePiece[i].style.left = x + 'px';
            gamePiece[i].style.top = y + 'px';
            gamePiece[i].style.backgroundImage = 'url("background.jpg")';
            gamePiece[i].style.backgroundPosition = -x + 'px ' + (-y) + 'px';
            ...
            if (checkMove(parseInt(this.innerHTML))) {
                ...
                this.style.color = "green"; //text color changes to green when a puzzle piece is near an empty space
